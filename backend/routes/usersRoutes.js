...
router.post('/football-match-info',matchController.footballMatchInfo)
router.post('/football-team-data',matchController.footballTeamData)
router.post('/football-player-data',matchController.footballPlayerByCountry)
...
router.post('/get_calender_football_match',matchController.getCalenderFootballMatch)
router.post('/football-betting-user',matchController.footballBettingUser)
router.post('/create-notification',userController.createNotification) 
router.get('/cricket-list-tournament',matchController.listCricketTournament)
