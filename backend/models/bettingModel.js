...
const bettingSchema = new Schema(
    {
      ...
      no_of_ball:{type:Number,default:0,required: [true, 'Please Provide a number of ball']},
      no_of_run:{type:Number,default:0},
      no_of_over:{type:Number,default:0,required: [true, 'Please Provide a number of over']},
