...
const footBallBet = require("../models/footballBettingModel");
...
exports.createNotification = async(req,res)=>{
  try {
    console.log(await sendNotification(['e86a0d6d-cf34-47da-96d4-59db1c51058a'],"join the bet match",{}));
...
exports.getCricketTopEmergingPlayers = async(req,res)=>{
  try{


    const getCricketTopEmerging = await betting.aggregate([
      {
        '$match': {
          'status': 2, 
          'status_text': 'win'
    ...
    getCricketTopEmerging.msg="Data Fetched Successfully!";
    return APIRes.getSuccessResult(getCricketTopEmerging, res);
  } catch (error) {
    return APIRes.getErrorResult(error, res);
  }
}
...
exports.getFootballTopEmergingPlayers = async(req,res)=>{
  try{


    const getFootballTopEmerging = await footBallBet.aggregate([
      {
        '$match': {
          'status': 2
        }
 ...
 getFootballTopEmerging.msg="Data Fetched Successfully!";
    return APIRes.getSuccessResult(getFootballTopEmerging, res);
  } catch (error) {
    return APIRes.getErrorResult(error, res);
  }
}
