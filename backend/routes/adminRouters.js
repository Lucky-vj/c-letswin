...
router.post('/update_document',adminController.updateDocument)
...
router.post('/update-news-content',adminController.updateNewsContent)
router.get('/get-news-content',adminController.getNewsContent)
router.post('/delete-news-content',adminController.deleteNewsContent)
router.post('/edit-news-content',adminController.editNewsContent)
